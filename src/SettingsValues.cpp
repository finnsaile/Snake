...
SettingsValues SettingsValues::m_instance;
...
void SettingsValues::setSettings()
{
    ofstream output;
...
void SettingsValues::getSettings()
{
...
SettingsValues& SettingsValues::getInstance()
{
    return m_instance;
}

int* SettingsValues::getVolumeMusic()
{
    return &m_volume_music;
}

int* SettingsValues::getVolumeClick()
{
    return &m_volume_click;
}

int* SettingsValues::getVolumeEat()
{
    return &m_volume_eat;
}

int* SettingsValues::getVolumeGameOver()
{
    return &m_volume_game_over;
}

int* SettingsValues::getLength()
{
    return &m_length;
}

int* SettingsValues::getFoodCount()
{
    return &m_food_count;
}

bool* SettingsValues::getWallCrash()
{
    return &m_wall_crash_b;
}

bool* SettingsValues::getSelfCrash()
{
    return &m_self_crash_b;
}

Difficulty* SettingsValues::getDifficulty() 
{
    return &m_difficulty;
}