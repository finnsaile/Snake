...
Counter::Counter(unsigned int init_score, int x, int y, bool high_bool): 
sf::Drawable(), 
m_black(0, 0, 0, 200), 
...
void Counter::increaseScore(unsigned int amount)
{
    m_score += amount;
...
void Counter::setCounterPosition()
{
